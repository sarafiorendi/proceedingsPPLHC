  ...
  \begin{center}
    ...
    \caption
        {Contours in the plane  BR($B^0_s \to \mu \mu$), BR($B^0_d \to \mu \mu$) for intervals of
          ...
          branching fractions (blue dot), with the error bars covering the 68.3\% confidence range for BR($B^0_s \to \mu \mu$)~\cite{ATLAS_Bmumu}.}
        \label{fig:BsBd}
  \end{center}
\end{figure}
